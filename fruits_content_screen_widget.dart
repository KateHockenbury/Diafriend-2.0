...
class FruitsContentScreenWidget extends StatefulWidget {
  const FruitsContentScreenWidget({Key? key}) : super(key: key);

  @override
  _FruitsContentScreenWidgetState createState() =>
      _FruitsContentScreenWidgetState();
}

class _FruitsContentScreenWidgetState extends State<FruitsContentScreenWidget> {
